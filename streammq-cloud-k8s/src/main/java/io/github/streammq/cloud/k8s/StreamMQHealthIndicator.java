 ...
 *
 * <p>由 {@link CloudK8sAutoConfiguration} 通过 {@code @Import} 装配，
 * 启用条件由 AutoConfiguration 的 {@code @ConditionalOnClass(StreamMQListenerContainer.class)}
 * 统一控制。通过 {@code ObjectProvider} 可选注入容器，避免对
 * {@code streammq-redisson} 的强依赖。
 *
 * <p>暴露的健康信息：
 * <ul>
 *   <li>状态：容器运行中为 UP，否则为 DOWN</li>
 *   <li>activeConsumers：当前已注册的消费者数量</li>
 *   <li>running：容器是否正在运行</li>
 * </ul>
 *
