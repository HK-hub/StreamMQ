...
class MessageProfileServiceTest {
  ...
  class GetProfile {
    ...
    void shouldReturnSuccessProfileWhenConsumeSucceeded() {
      ...
      TraceRecord consume =
          consumeRecord("msg-1", "test-topic", "test-group", true, 2000L, 100L, consumeAttrs);
    ...
    void shouldReturnFailedStatusWhenConsumeFailed() {
      ...
      TraceRecord consume =
          consumeRecord("msg-3", "test-topic", "test-group", false, 2000L, 100L, failAttrs);
    ...
    void shouldReturnDlqStatusWhenRoutePathContainsDlqTopic() {
      ...
      TraceRecord dlqConsume =
          consumeRecord("msg-4", "test-topic-dlq", "test-group", false, 3000L, 50L, Map.of());
