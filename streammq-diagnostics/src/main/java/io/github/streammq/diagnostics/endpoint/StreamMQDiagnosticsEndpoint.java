 ...
 * <p>提供以下端点：
 * <ul>
 *   <li>{@code GET /streammq/diagnostics/profile/{messageId}} - 获取消息画像</li>
 *   <li>{@code GET /streammq/diagnostics/slow-consume?topic=&group=} - 诊断慢消费</li>
 *   <li>{@code GET /streammq/diagnostics/backlog?topic=&group=} - 诊断积压</li>
 *   <li>{@code GET /streammq/diagnostics/dlq?group=} - 诊断死信队列</li>
 *   <li>{@code GET /streammq/diagnostics/slow-consumers} - 列出所有慢消费者</li>
 *   <li>{@code GET /streammq/diagnostics/all-backlogs} - 列出所有积压报告</li>
 *   <li>{@code GET /streammq/diagnostics/health} - 诊断健康概览</li>
 * </ul>
 *
...
public class StreamMQDiagnosticsEndpoint {
     ...
     */
    public StreamMQDiagnosticsEndpoint(StreamMQDiagnosticsService diagnosticsService,
    ...
    public SlowConsumeReport diagnoseSlowConsume(@RequestParam String topic,
     ...
     */
    @GetMapping("/backlog")
    public BacklogReport diagnoseBacklog(@RequestParam String topic,
                                        @RequestParam String group) {
