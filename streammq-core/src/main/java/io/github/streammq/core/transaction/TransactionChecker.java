...
public interface TransactionChecker<T> {
     ...
     * @return 本地事务状态：
     *         <ul>
     *           <li>{@link LocalTransactionState#COMMIT_MESSAGE} - 提交半消息</li>
     *           <li>{@link LocalTransactionState#ROLLBACK_MESSAGE} - 回滚半消息</li>
     *           <li>{@link LocalTransactionState#UNKNOW} - 仍未知，等待下次回查</li>
     *         </ul>
