 ...
 * <ul>
 *   <li>{@code LogAndDropDlqFailureStrategy} - 始终丢弃（仅记录日志）</li>
 *   <li>{@code LimitedRetryDlqFailureStrategy} - 有限次重试后丢弃</li>
 *   <li>{@code SecondaryDlqFailureStrategy} - 有限次重试后转投二级死信</li>
 * </ul>
 *
