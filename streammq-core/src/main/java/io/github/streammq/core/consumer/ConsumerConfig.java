...
/**
 * 消费者配置，替代弱类型 {@code Map<String, Object>} 的强类型值对象。
 *
 * <p>使用 Builder 模式构造：
 * <pre>{@code
...
public class ConsumerConfig {
     ...
     * 设置为 true 时，消费者从 DLQ Stream 消费死信消息，
     ...
     *
     * <p>通常由容器在注册 Listener 时通过 {@code io.github.streammq.core.util.BodyTypeResolver}
     * 解析 {@code StreamMqListener<T>} 的泛型 T 自动填入，无需用户手动配置。
     *
