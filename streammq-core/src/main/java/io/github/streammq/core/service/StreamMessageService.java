 ...
 *
 * <p>用户无需手动构造消息对象，只需传入 body 和 topic 即可发送。
 * 类似 RocketMQ 的 DefaultMQPushProducer 封装层。
 *
 * <p><b>接口设计</b>：本接口继承了多个细粒度接口，用户可以按需注入：
 * <ul>
 *   <li>{@link BasicMessageService} - 基础同步发送</li>
 *   <li>{@link AsyncMessageService} - 异步发送</li>
 *   <li>{@link OnewayMessageService} - 单向发送</li>
 *   <li>{@link BatchMessageService} - 批量发送</li>
 *   <li>{@link DelayMessageService} - 延时消息</li>
 *   <li>{@link TransactionMessageService} - 事务消息</li>
 * </ul>
 *
