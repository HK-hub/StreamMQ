 ...
 * DLQ（死信队列）消费者注解。
 *
 * <p>标注在 {@link io.github.streammq.core.listener.StreamMqListener} 实现类上，
 ...
 * <p>使用示例：
 * <pre>{@code
 * @StreamMqDlqListener(topic = "order-topic", consumerGroup = "order-consumer-group")
 * public class OrderDlqHandler implements StreamMqListener<String> {
 *     @Override
 ...
 * 避免死信消息无限循环。如需自定义失败处理，请在 Listener 内部捕获异常并处理。
 *
...
@Documented
public @interface StreamMqDlqListener {
