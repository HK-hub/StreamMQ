...
public final class DlqFailureDecision {
    ...
    public boolean isDrop() { return type == Type.DROP; }
    public boolean isRetry() { return type == Type.RETRY; }
    public boolean isSecondaryDlq() { return type == Type.SECONDARY_DLQ; }
    ...
    @Override
    public int hashCode() { return Objects.hash(type, retryDelay); }
