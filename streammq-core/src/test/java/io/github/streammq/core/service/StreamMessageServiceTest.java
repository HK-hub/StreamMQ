...
class StreamMessageServiceTest {
  ...
  class BatchSend {
    ...
    void sendBatchWithMetadata() {
      ...
      MessageMetadataBuilder metadata = MessageMetadataBuilder.create().tag("tagA").keys("k1");
  ...
  class DelaySend {
    ...
    void sendDelayWithMetadataAndTimeout() {
      ...
      MessageMetadataBuilder metadata = MessageMetadataBuilder.create().delayTimeMillis(5000L);
