...
class BatchMessageTest {
  ...
  class BuilderAdd {
    ...
    void addMultiple() {
      ...
      BatchMessage<String> batch = BatchMessage.<String>withTopic("topic").add(m1).add(m2).build();
  ...
  class BuilderAddAll {
    ...
    void addAllBatch() {
      ...
      BatchMessage<String> batch =
          BatchMessage.<String>withTopic("topic").addAll(Arrays.asList(m1, m2, m3)).build();
