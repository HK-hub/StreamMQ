...
class MessageBuilderTest {
  ...
  class WithAliasMethods {
    ...
    void withTag() {
      Message<String> message = MessageBuilder.<String>withTopic("t").tag("tag1").body("b").build();
    ...
    void withKeys() {
      Message<String> message = MessageBuilder.<String>withTopic("t").keys("k1").body("b").build();
    ...
    void withBody() {
      Message<String> message = MessageBuilder.<String>withTopic("t").body("body-val").build();
    ...
    void withProperty() {
      Message<String> message =
          MessageBuilder.<String>withTopic("t").withProperty("traceId", "t-1").body("b").build();
    ...
    void withUserProperty() {
      Message<String> message =
          MessageBuilder.<String>withTopic("t").withUserProperty("biz", "val").body("b").build();
    ...
    void withDelayLevel() {
      Message<String> message =
          MessageBuilder.<String>withTopic("t").delayLevel(DelayLevel.SECOND_10).body("b").build();
  ...
  class TopicTagHandling {
    ...
    void tag_nullStaysNull() {
      Message<String> message = MessageBuilder.<String>withTopic("t").tag(null).body("b").build();
