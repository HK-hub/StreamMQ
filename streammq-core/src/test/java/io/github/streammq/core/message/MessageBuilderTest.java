...
class MessageBuilderTest {
    ...
    class StaticFactories {
        ...
        void withPayload() {
            Message<String> message = MessageBuilder.<String>withPayload("body-content")
                .topic("topic")
                .build();
    ...
    class TopicTagHandling {
        ...
        void topic_trims() {
            Message<String> message = MessageBuilder.<String>create()
                .topic("  spaced-topic  ").body("b").build();
    ...
    class Defaults {
        ...
        void bornTimestamp_explicitKept() {
            Message<String> message = MessageBuilder.<String>withTopic("t")
                .bornTimestamp(42L).body("b").build();
        ...
        void transactionId_passedThrough() {
            Message<String> message = MessageBuilder.<String>withTopic("t")
                .transactionId("tx-100").body("b").build();
