...
class StreamMQAssertionsTest {
    ...
    void assertThatSendResult_isSuccess() {
        SendResult result =
                new SendResult(
                        new MessageId("123-0"), "test-topic", "tag", System.currentTimeMillis());
    ...
    void assertThatSendResult_hasTopic() {
        SendResult result =
                new SendResult(
                        new MessageId("123-0"), "order-topic", "tag", System.currentTimeMillis());
    ...
    void assertThatSendResult_hasTag() {
        SendResult result =
                new SendResult(
                        new MessageId("123-0"), "topic", "created", System.currentTimeMillis());
    ...
    void assertThatSendResult_hasSendStatus() {
        SendResult result =
                new SendResult(new MessageId("123-0"), "topic", "tag", System.currentTimeMillis());
    ...
    void assertThatMessage_hasTopic() {
        Message<String> message =
                MessageBuilder.<String>withTopic("order-topic").body("test").build();
    ...
    void assertThatMessage_hasTag() {
        Message<String> message =
                MessageBuilder.<String>withTopic("topic").tag("created").body("test").build();
    ...
    void assertThatMessage_hasKeys() {
        Message<String> message =
                MessageBuilder.<String>withTopic("topic").keys("order-123").body("test").build();
    ...
    void assertSendResultsSuccess_allSuccess() {
        List<SendResult> results =
                List.of(
                        new SendResult(
                                new MessageId("1-0"), "topic", "tag", System.currentTimeMillis()),
                        new SendResult(
                                new MessageId("2-0"), "topic", "tag", System.currentTimeMillis()));
