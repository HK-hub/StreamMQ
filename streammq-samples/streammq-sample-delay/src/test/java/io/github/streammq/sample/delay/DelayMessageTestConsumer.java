 ...
 *
 * <p>使用独立的消费者组（{@code delay-order-consumer-group-it}）， 与业务消费者组隔离，确保不影响正常消费逻辑。
 *
...
public class DelayMessageTestConsumer implements StreamMessageConcurrentlyConsumer<String> {
    ...
    public ConsumeAction onMessage(Message<String> message, ConsumeContext context) {
        ...
        log.info(
                "[TestConsumer] 收到延时消息: orderId={}, tag={}, body={}",
                message.getKeys(),
                message.getTag(),
                message.getBody());
     ...
     */
    public static void awaitMessages(int expectedCount, long timeoutMillis)
