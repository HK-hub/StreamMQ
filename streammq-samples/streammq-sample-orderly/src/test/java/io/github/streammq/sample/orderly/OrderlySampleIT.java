        ...
        .untilAsserted(
            () -> {
              ...
              List<Message<String>> order1Messages =
                  messages.stream().filter(m -> orderId1.equals(m.getKeys())).toList();
              List<Message<String>> order2Messages =
                  messages.stream().filter(m -> orderId2.equals(m.getKeys())).toList();
              List<Message<String>> order3Messages =
                  messages.stream().filter(m -> orderId3.equals(m.getKeys())).toList();
    ...
    await()
        ...
        .untilAsserted(
            () -> {
              ...
              assertThat(received.getUserProperties()).containsEntry("sequence", "42");
              assertThat(received.getUserProperties()).containsEntry("source", "orderly-sample");
            });
  }
