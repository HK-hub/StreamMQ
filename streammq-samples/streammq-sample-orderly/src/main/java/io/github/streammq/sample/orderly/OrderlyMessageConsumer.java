 ...
 * 顺序消息消费者示例。
 *
 * <p>通过 {@link MessageModel#ORDERLY} 指定顺序消费模式，
...
public class OrderlyMessageConsumer implements StreamMessageOrderlyConsumer<String> {
    ...
    public ConsumeAction onMessage(Message<String> message, ConsumeOrderlyContext context) throws Exception {
        ...
        log.info("Received orderly message: orderId={}, sequence={}, shardingKey={}, body={}, count={}",
                orderId, sequence, message.getShardingKey(), message.getBody(),
