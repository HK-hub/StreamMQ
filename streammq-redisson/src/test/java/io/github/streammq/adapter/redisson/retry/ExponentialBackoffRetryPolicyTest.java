...
/**
 * {@link ExponentialBackoffRetryPolicy} 单元测试，覆盖默认参数、自定义参数构造校验、
 * 指数退避计算边界、shouldStopRetry 与 getter 方法。
 *
...
class ExponentialBackoffRetryPolicyTest {
    ...
    void customParameters() {
        ExponentialBackoffRetryPolicy policy =
            new ExponentialBackoffRetryPolicy(500L, 1.5, 60_000L, 8);
    ...
    void maxEqualsInitial() {
        ExponentialBackoffRetryPolicy policy =
            new ExponentialBackoffRetryPolicy(1000L, 2.0, 1000L, 4);
