...
class RedisStreamMQTraceServiceTest {
  ...
  void queryByMessageIdFound() {
    Map<String, String> fields =
        buildFields("msg-1", "topic-1", "cg-1", TraceType.SEND, true, 1000L, 10L, "trace-1", "{}");
  ...
  void queryByMessageIdSortedByTimestamp() {
    Map<String, String> fields1 =
        buildFields("msg-1", "topic-1", "cg-1", TraceType.SEND, true, 2000L, 10L, "trace-1", "{}");
  ...
  void queryByTopicFound() {
    ...
    Map<String, String> fields =
        buildFields("msg-1", "topic-1", "cg-1", TraceType.SEND, true, now, 10L, "trace-1", "{}");
  ...
  void queryByGroupFound() {
    long now = System.currentTimeMillis();
    Map<String, String> fields =
        buildFields("msg-1", "topic-1", "cg-1", TraceType.CONSUME, true, now, 5L, "trace-1", "{}");
