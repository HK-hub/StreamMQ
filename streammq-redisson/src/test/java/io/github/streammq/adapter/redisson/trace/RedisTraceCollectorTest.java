...
/**
 * {@link RedisTraceCollector} 单元测试，覆盖启用状态、name、记录方法、
 * null 入参、异常容忍与构造参数校验。
 *
...
class RedisTraceCollectorTest {
    ...
    void recordSendWithAttributes() {
        ...
        TraceCollector.SendTraceContext ctx = new TraceCollector.SendTraceContext(
            "topic-1", "tag-1", new MessageId("3-0"), "pg",
            System.currentTimeMillis(), true, 5L,
            "trace-3", attrs);
