 ...
 *
 * <p>使用内置线程安全的 {@link ObjectMapper}（Jackson 文档保证 ObjectMapper 在配置完成后线程安全）。 默认注册：
 *
 * <ul>
 *   <li>{@link JavaTimeModule} - 支持 JSR-310 时间类型
 *   <li>禁用 {@code WRITE_DATES_AS_TIMESTAMPS} - 时间以 ISO-8601 字符串表示
 * </ul>
 *
