...
public class RedissonOrderlyShardLockManager implements OrderlyShardLockManager {
     ...
     */
    @Override
    public RLock[] createShardLocks(String defaultNs, String topic, String group, String ns, int shardCount) {
        if (shardCount <= 0) {
            return null;
        }
    ...
    @Override
    public ConsumeAction consumeWithShardLock(Message<?> message, ListenerRegistration reg,
