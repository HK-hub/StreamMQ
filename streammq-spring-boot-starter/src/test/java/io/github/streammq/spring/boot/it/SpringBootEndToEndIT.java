...
class SpringBootEndToEndIT {
    ...
    void cleanupRedis() {
        if (redissonClient != null && !redissonClient.isShutdown()) {
            redissonClient
                    .getKeys()
                    .deleteByPattern("streammq:" + properties.getNamespace() + ":*");
        }
    }
    ...
    void syncSendBatch_threeMessages_allReceived() {
        ...
        await().atMost(15, TimeUnit.SECONDS)
                .untilAsserted(
                        () -> {
                            assertThat(e2eStringListener.receivedBodies)
                                    .contains(body1, body2, body3);
                        });
    }
    ...
    void delayMessage_schedulerTransfersAndListenerConsumes() {
        ...
        await().atMost(5, TimeUnit.SECONDS)
                .untilAsserted(
                        () -> {
                            RScoredSortedSet<String> zsetAfter =
                                    redissonClient.getScoredSortedSet(delayZSetKey);
