...
public class StreamMQCoreAutoConfiguration {
  ...
  public MessageConverter streamMQMessageConverter(
    ...
    LOG.debug(
        "Using DefaultMessageConverter with serializer={}", serializer.getClass().getSimpleName());
    return converter;
  }
  ...
  public StreamMessageTemplate streamMQTemplate(
    ...
    ProducerConfig defaultConfig =
        ProducerConfig.builder()
            ...
            .build();
    LOG.debug(
        "Creating DefaultStreamMessageTemplate: defaultGroup={}, transactionGroup={}, namespace={}",
        defaultGroup,
        txGroup,
    ...
    if (scanner != null) {
      ...
      LOG.debug(
          "TransactionScanner injected into DefaultStreamMessageTemplate: full half-message flow"
              + " enabled");
    }
