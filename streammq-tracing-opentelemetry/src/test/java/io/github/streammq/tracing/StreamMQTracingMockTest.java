...
class StreamMQTracingMockTest {
  ...
  class MessageTraceBuilding {
    ...
    void shouldMarkFailedStatus() {
      ...
      when(traceService.queryByMessageId("msg-002")).thenReturn(List.of(sendRecord, failRecord));
    ...
    void shouldMarkDlqStatus() {
      ...
      when(traceService.queryByMessageId("msg-003")).thenReturn(List.of(sendRecord, dlqRecord));
