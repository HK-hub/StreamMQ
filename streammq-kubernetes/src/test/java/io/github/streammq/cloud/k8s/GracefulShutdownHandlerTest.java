 ...
 *
 * <p>使用 Mockito 模拟 {@link StreamMQListenerContainer} 与 {@link ObjectProvider}，
 * 验证 destroy() 方法在不同场景下的行为，以及 isShuttingDown() 标志的转换。
 */
...
class GracefulShutdownHandlerTest {
    ...
    @Mock
    private ObjectProvider<StreamMQListenerContainer> containerProvider;
