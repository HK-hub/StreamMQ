 ...
 * <ul>
 *   <li>Create/update/delete topics with partition count and retention settings</li>
 *   <li>Associate topics with StreamMQCluster through clusterRef</li>
 *   <li>Supports max-length and time-based retention policies</li>
 * </ul>
 *
