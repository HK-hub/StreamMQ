 ...
 */
@SpringBootTest(classes = StreamMQBinderDiscoveryIT.TestApp.class,
        properties = {
...
class StreamMQBinderDiscoveryIT {
    ...
    void shouldDiscoverStreamMQBinder() {
        Binder<?, ?, ?> binder = binderFactory.getBinder("streammq", org.springframework.messaging.MessageChannel.class);
    ...
    void shouldHaveBinderBean() {
        ...
        Binder<?, ?, ?> binder = binderFactory.getBinder(null, org.springframework.messaging.MessageChannel.class);
        assertThat(binder).isNotNull();
    }
